...
<script lang="ts" setup>
  ...
  //   types
  import { FileItem, UploadResultStatus, Wrapper } from '../types/typing';
  ...
  // 删除
  function handleRemove(wrapper: Wrapper) {
    const { record, uidKey } = wrapper;
    const index = fileListRef.value.findIndex((item) => item.uuid === record[uidKey]);
